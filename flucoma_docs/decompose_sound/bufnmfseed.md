...
Information on using Nonnegative Double Singular Value Decomposition for seeing Non-Negative Matrix Factorization

### Nndsvd (methods.seeding.nndsvd)

A Python implementation using Nonnegative Double Singular Value Decomposition for seeing Non-Negative Matrix Factorization
