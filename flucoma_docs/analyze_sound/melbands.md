...
![](images/melbands_img_1.jpg)

Normalized Triangle Filters

### Unnormalized Triangle Filters

![](images/melbands_img_2.jpg)
...
![](images/melbands_img_3.jpg)

One spectral frame from a drum loop with accompanying triangle filters (normalized) and MelBands.

### MelBands analysis of one spectral frame of a trombone tone.

![](images/melbands_img_4.jpg)

One spectral frame from a trombone tone with accompanying triangle filters (normalized) and MelBands.
